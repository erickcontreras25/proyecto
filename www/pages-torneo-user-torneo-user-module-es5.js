        ...
        value: function registrarEquipo() {
          ...
          this.torneoService.postTorneoEquipo(this.torneoEquipo).subscribe(function (data) {
            if (data === 'Torneo ya esta lleno.') {
              _this4.alertaService.alertaInformativa(data);
            } else {
            ...
            _this4.alertaService.alertaInformativa('El equipo ya esta inscrito. Puedes verlo en Mis Torneos');
          });
        }
      }, {
        key: "validar",
