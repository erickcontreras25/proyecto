    ...
    function () {
      ...
      _createClass(ReservarPage, [{
        ...
        value: function validarFecha() {
          ...
          var dInicial = moment__WEBPACK_IMPORTED_MODULE_5__(this.hInicio).format('MM-DD-YYYY HH:mm');
          var dFinal = moment__WEBPACK_IMPORTED_MODULE_5__(this.hFin).format('MM-DD-YYYY HH:mm');
          var abre = moment__WEBPACK_IMPORTED_MODULE_5__(this.hInicio).format('HH');
          var cierra = moment__WEBPACK_IMPORTED_MODULE_5__(this.hFin).format('HH');
          ...
          var diaReserva = moment__WEBPACK_IMPORTED_MODULE_5__(this.hInicio).format('MM-DD-YYYY');
          ...
          var inic = moment__WEBPACK_IMPORTED_MODULE_5__(this.hInicio);
          var fin = moment__WEBPACK_IMPORTED_MODULE_5__(this.hFin);
