...
let ReservarPage = class ReservarPage {
    ...
    validarFecha() {
        ...
        const dInicial = moment__WEBPACK_IMPORTED_MODULE_5__(this.reservacion.horaInicial).format('MM-DD-YYYY HH:mm');
        const dFinal = moment__WEBPACK_IMPORTED_MODULE_5__(this.reservacion.horaFinal).format('MM-DD-YYYY HH:mm');
        const abre = moment__WEBPACK_IMPORTED_MODULE_5__(this.reservacion.horaInicial).format('HH');
        const cierra = moment__WEBPACK_IMPORTED_MODULE_5__(this.reservacion.horaFinal).format('HH');
        ...
        const diaReserva = moment__WEBPACK_IMPORTED_MODULE_5__(this.reservacion.horaInicial).format('MM-DD-YYYY');
