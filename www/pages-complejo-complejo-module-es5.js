    ...
    function () {
      ...
      _createClass(ComplejoPage, [{
        ...
        value: function verificar() {
          ...
          var inicio = moment__WEBPACK_IMPORTED_MODULE_8__(this.abre).format('MM-DD-YYYY HH:mm');
          var cierre = moment__WEBPACK_IMPORTED_MODULE_8__(this.cierr).format('MM-DD-YYYY HH:mm');
