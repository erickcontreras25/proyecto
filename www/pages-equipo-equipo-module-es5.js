...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-equipo-equipo-module"], {
  ...
  function srcAppPagesEquipoEquipoPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function EquipoPage(usuarioService, equipoService, navCtrl, alertaService) {
      ...
      _createClass(EquipoPage, [{
        ...
        value: function crearEquipo() {
          ...
          this.equipoService.postEquipo(this.equipo).subscribe(function (data) {
            ...
            _this4.alertaService.alertaInformativa('Para completar la creacion debes dar click en boton unirme a equipo');
        ...
        value: function modificarEquipo() {
          ...
          this.equipoService.putEquipo(this.idEquipo, this.equipo).subscribe(function (data) {
            _this5.clear();
        ...
        value: function uniraEquipo() {
          ...
          this.equipoService.postEquipoUser(this.equipoUser).subscribe(function (data) {
            _this8.equipoUsers.push(_this8.equipoUser);

            _this8.unido = true;

            _this8.obtenerEquipoUserxIduser();
          }, function (error) {
            console.log(error);
          });
        }
        ...
        value: function salirEquipo(id) {
          ...
          this.equipoService.deleteEquipoUser(id, this.equipoUser.userId).subscribe(function (resp) {
            _this9.alertaService.alertaInformativa('Hecho!!');

            _this9.obtenerEquipoUserxIduser();
        ...
        value: function sacarEquipo(id) {
          ...
          this.equipoService.deleteEquipoUser(this.equipoUser.equipoId, id).subscribe(function (resp) {
            _this10.alertaService.alertaInformativa('Hecho!!');

            _this10.obtenerEquipoUserxIduser();

            _this10.obtenerEquipoUserId(_this10.equipoUser.equipoId);
          }, function (error) {
            return console.log(error);
          });
        }
