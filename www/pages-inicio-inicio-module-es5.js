...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-inicio-inicio-module"], {
  ...
  function srcAppPagesInicioInicioPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function InicioPage(apiServi, geolocation, usuarioService) {
      ...
      _createClass(InicioPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.user = this.usuarioService.getUsuario(); // console.log('PASO 4 >> ');

          console.log(this.user); // console.log('PASO 5 >> ' + this.user.isAdmin);
        ...
        value: function loadMap() {
          ...
          regeneratorRuntime.mark(function _callee() {
            var rta, myLatLng, map, markers, valor, i, popup;
                  ...
                  case 2:
                    ...
                    for (i = 0; i < this.complejos.length; i++) {
                      if (this.complejos[i].longitud != null && this.complejos[i].latitud != null) {
                        popup = new mapboxgl.Popup().setHTML(this.complejos[i].nombre); // console.log(this.complejos[i].nombre);
                        // const marker = new mapboxgl.Marker()
                        //   .setLngLat( [ this.complejos[i].longitud, this.complejos[i].latitud] )
                        //   .setPopup(popup)
                        //   .addTo( map );

                        markers[valor] = new mapboxgl.Marker().setLngLat([this.complejos[i].longitud, this.complejos[i].latitud]).setPopup(popup).addTo(map);
                        valor++;
                      }
                    } // const marker = new mapboxgl.Marker()
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_apiservi_service__WEBPACK_IMPORTED_MODULE_2__["ApiserviService"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_3__["Geolocation"], src_app_services_usuario_service__WEBPACK_IMPORTED_MODULE_4__["UsuarioService"]])], InicioPage);
    /***/
  }
}]);
